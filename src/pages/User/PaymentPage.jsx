...
const PaymentPage = () => {
  ...
  if (loading)
    return <div className="p-20 text-center">Đang khởi tạo giao dịch...</div>;
      ...
      <div className="max-w-md w-full bg-white rounded-[40px] shadow-2xl overflow-hidden">
        ...
        <div className="p-8 flex flex-col items-center">
          <p className="text-slate-500 text-sm mb-6 text-center">
            Quét mã QR dưới đây bằng ứng dụng Ngân hàng hoặc Ví điện tử để thanh
            toán cho hóa đơn <strong>#{invoiceId}</strong>
          </p>
        ...
        <div className="bg-slate-50 p-4 text-center">
          <p className="text-[10px] text-slate-400 uppercase font-bold italic">
            Giao dịch an toàn bảo mật bởi VNPAY Sandbox
          </p>
        </div>
      </div>
    </div>
